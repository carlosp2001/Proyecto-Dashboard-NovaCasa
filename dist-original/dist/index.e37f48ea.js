...
const controlResults = async function() {
    try {
        ...
        if (!_modelJs.checkForCatalog()) {
            ...
            (0, _catalogConfigViewJsDefault.default).render(_modelJs.state.user.catalogs);
...
const controlImportProperties = async function() {
    ...
    (0, _importPropertiesViewJsDefault.default).render(undefined, true, true);
